...
class SEOUtils {
  ...
  getHomeMeta() {
    return {
      title: 'iPeep - Look at Instagram Without an Account | No Login Needed | Free 2026',
      description: 'Want to see someone\'s Instagram without an account? iPeep lets you look at stories, posts, and profiles without logging in or signing up. No app needed — just type their username. Free and anonymous.',
      canonical: config.SEO.SITE_URL,
      keywords: 'how to look at instagram without an account, see someones instagram without account, view instagram without logging in, check instagram without signing up, look at instagram stories without them knowing, instagram without account, instagram no login, how to see instagram posts without account, browse instagram without signing up, view instagram stories without account, instagram story viewer, save instagram stories, download instagram stories to phone, instagram viewer free, picuki alternative, storiesig alternative, anonyig alternative, how to stalk instagram without account, check someones instagram anonymously, see instagram profile without login, ig story viewer no account, watch ig stories without logging in, ver instagram sin cuenta, ver historias instagram sin iniciar sesion, ver instagram sem conta, ver stories sem login',
